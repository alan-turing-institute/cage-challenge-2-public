...
class LoadBlueAgent:
    ...
    def __init__(self) -> None:
        ...
        self.CTRL_checkpoint_pointer = two_up + '/logs/hier/PPO_hier_2022-07-11_10-57-15/PPO_HierEnv_d78d3_00000_0_2022-07-11_10-57-15/checkpoint_000323/checkpoint-323'
    ...
    def get_action(self, obs, action_space):
        ...
        if len(self.rewards) == 3 and self.rewards != 0:
            self.adversary = 'B_line'
        elif len(self.rewards) == 3:
