...
import torch
from ray.rllib.models.torch.torch_modelv2 import TorchModelV2
from CybORGMAML import CybORGMAMLWrapped as CybORGAgent
...
if __name__ == "__main__":
    ...
    ModelCatalog.register_custom_model("CybORG_MAML_Model", TorchModel)
    ...
    analysis = tune.run(algo, # Algo to use - alt: ppo.PPOTrainer, impala.ImpalaTrainer
                        ...
                        name=algo.__name__ + '_' + time.strftime("%Y-%m-%d_%H-%M-%S"),
                        local_dir=log_dir,
                        stop=stop,
                        #restore=checkpoint,
