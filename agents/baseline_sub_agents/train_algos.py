...
if __name__ == "__main__":
    ...
    #checkpoint = '/Users/mylesfoley/Desktop/Imperial/git/turing/cage-challenge-2/logs/various/PPO_LSTM_3_layer_RedMeanderAgent_2022-06-27_09-22-31/PPO_CybORGAgent_49ffe_00000_0_2022-06-27_09-22-31/checkpoint_001250/checkpoint-1250'
    ...
    analysis = tune.run(algo, # Algo to use - alt: ppo.PPOTrainer, impala.ImpalaTrainer
                        ...
                        name=algo.__name__ + '_attention_' +CybORGAgent.agents['Red'].__name__+ '_' + time.strftime("%Y-%m-%d_%H-%M-%S"),
                        local_dir=log_dir,
                        stop=stop,
                        #restore=checkpoint,
